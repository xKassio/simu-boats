...
/// For gz-waves1-dynamic-geometry-system developers: Apply this macro to gz-waves1-dynamic-geometry-system
...
/// For gz-waves1-dynamic-geometry-system developers: Use this macro to indicate that a
