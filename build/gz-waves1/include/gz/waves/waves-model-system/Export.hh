...
/// For gz-waves1-waves-model-system developers: Apply this macro to gz-waves1-waves-model-system
...
/// For gz-waves1-waves-model-system developers: Use this macro to indicate that a
