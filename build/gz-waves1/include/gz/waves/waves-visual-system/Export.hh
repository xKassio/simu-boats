...
/// For gz-waves1-waves-visual-system developers: Apply this macro to gz-waves1-waves-visual-system
...
/// For gz-waves1-waves-visual-system developers: Use this macro to indicate that a
