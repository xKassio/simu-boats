# - Config file for the gz-waves1-rendering-ogre2 component
#
# This should only be invoked by gz-waves1-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-waves1 COMPONENTS rendering-ogre2)
#
# This creates the following targets:
#
#   Component library target                - gz-waves1::gz-waves1-rendering-ogre2
#   Alternative target name                 - gz-waves1::rendering-ogre2
...
# this is discouraged:
#
#   gz-waves1-rendering-ogre2_LIBRARY  - Component library (actually contains gz-waves1::rendering-ogre2)
#
# We will also set gz-waves1-rendering-ogre2_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-waves1-rendering-ogre2_CONFIG_INCLUDED)
  return()
endif()
set(gz-waves1-rendering-ogre2_CONFIG_INCLUDED TRUE)

if(NOT gz-waves1-rendering-ogre2_FIND_QUIETLY)
  message(STATUS "Looking for gz-waves1-rendering-ogre2 -- found version 1.0.0")
endif()
...
# dependencies.
if(gz-waves1-rendering-ogre2_FIND_REQUIRED)
...
# dependencies.
if(gz-waves1-rendering-ogre2_FIND_QUIETLY)
...
if(NOT gz-waves1-rendering-ogre2_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-waves1-rendering-ogre2")
endif()
if(NOT gz-waves1_CONFIG_INCLUDED)
  find_package(gz-waves1 1.0.0 EXACT ${gz_package_quiet} ${gz_package_required})
endif()
find_package(gz-waves1 1.0.0 EXACT ${gz_package_quiet} ${gz_package_required} COMPONENTS gz-waves1-rendering)
# --------------------------------

if(NOT TARGET gz-waves1::gz-waves1-rendering-ogre2)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-waves1-rendering-ogre2-targets.cmake")
  ...
  add_library(gz-waves1::rendering-ogre2 INTERFACE IMPORTED)
  set_target_properties(gz-waves1::rendering-ogre2 PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-waves1::gz-waves1-rendering-ogre2")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-waves1::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-waves1::gz-waves1-rendering-ogre2")
endif()

set(gz-waves1-rendering-ogre2_LIBRARY gz-waves1::gz-waves1-rendering-ogre2)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-waves1-rendering-ogre2 "gz-waves1-rendering-ogre2")
